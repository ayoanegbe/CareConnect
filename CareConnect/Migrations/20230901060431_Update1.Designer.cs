...
namespace CareConnect.Migrations
{
    ...
    [Migration("20230901060431_Update1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CareConnect.Models.JobPosition", b =>
                {
                    b.Property<int>("JobPositionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CareConnect.Models.JobPositionHistory", b =>
                {
                    b.Property<int>("JobPositionHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("JobPositionHistoryId"), 1L, 1);
                    ...
                    b.HasKey("JobPositionHistoryId");

                    b.HasIndex("EmployeeId");

                    b.ToTable("JobPositionHistories");
                });
            ...
            modelBuilder.Entity("CareConnect.Models.Employee", b =>
                {
                    b.HasOne("CareConnect.Models.JobPosition", "JobPosition")
                        .WithMany()
